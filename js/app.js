...
import { initDomCache } from './core/dom.js?v=8';
import { applyGlobalFont, showToast, switchScreen, removeContextMenu } from './core/utils.js?v=8';
import * as dataService from './core/dataService.js?v=8';
// aiService 已通过全局 script 加载，使用 window.AiService

import * as chatRoom from './ui/chatRoom.js?v=8';
import * as chatList from './ui/chatList.js?v=8';
import * as homeScreen from './ui/homeScreen.js?v=8';
import { updateActiveWorldStatus } from './ui/homeScreen.js?v=8';
import * as PromptDefaults from './ui/promptDefaults.js?v=8';
import * as settings from './ui/settings.js?v=8';
import * as wallpaper from './ui/wallpaper.js?v=8';
import * as customize from './ui/customize.js?v=8';
import * as fontSettings from './ui/fontSettings.js?v=8';

import * as worldBook from './systems/worldBook.js?v=8';
import * as apiSettings from './systems/apiSettings.js?v=8';
import * as imgGenSettings from './systems/imgGenSettings.js?v=8';
import * as stickers from './systems/stickers.js?v=8';
import * as voice from './systems/voice.js?v=8';
import * as photoVideo from './systems/photoVideo.js?v=8';
import * as wallet from './systems/wallet.js?v=8';
import * as gift from './systems/gift.js?v=8';
import * as timeSkip from './systems/timeSkip.js?v=8';
import * as imageRecognition from './systems/imageRecognition.js?v=8';
import * as group from './systems/group.js?v=8';
import * as videoCall from './systems/videoCall.js?v=8';
...
async function initApp() {
  ...
  ['img-gen-status', 'tts-global-status', 'tts-settings-card', 'tts-edit-btn',
   ...
   'api-edit-name', 'api-edit-provider', 'api-edit-host', 'api-edit-path', 'api-edit-key', 'api-edit-fetch-btn', 'api-edit-model',
